...
namespace hsp.vs
{
    ...
    internal class HSPCompletionHandlerProvider : IVsTextViewCreationListener
    {
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            Func<HSPCompletionCommandHandler> createCommandHandler =
                delegate { return new HSPCompletionCommandHandler(textViewAdapter, textView, this); };
            textView.Properties.GetOrCreateSingletonProperty(createCommandHandler);
        }
    }

    internal class HSPCompletionCommandHandler : IOleCommandTarget
    {
        private readonly IOleCommandTarget _nextCommandHandler;
        private readonly HSPCompletionHandlerProvider _provider;
