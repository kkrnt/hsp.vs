...
namespace hsp.vs
{
    internal class HSPCompletionSource : ICompletionSource
    {
        private readonly ITextBuffer _buffer;
        private readonly HSPCompletion _provider;

        public HSPCompletionSource(HSPCompletion provider, ITextBuffer buffer)
        {
            _buffer = buffer;
            _provider = provider;
        }
